...
const AnnotationEditModalForm: FC<Props> = ({feedback, material, isUserLoading}) => {
  ...
  return (
    <>
      <form id='kt_modal_add_feedback_form' className='form' onSubmit={formik.handleSubmit} noValidate>
        <div className="mb-12">
        ...
        <div className="col-md-12">
          <div className='row'>
            ...
            <div className='col-md-6'>
              <div className='mb-6'>
                <form id='kt_modal_add_annotation_form' className='form' onSubmit={formik.handleSubmit} noValidate>
                  {inputList}
                  <div className="mb-6">
                    <button
                      type='button'
